...
func (b encoder) Encode(u uuid.UUID) string {
	var num big.Int
...
func (b encoder) Decode(u string) (uuid.UUID, error) {
...
func (b *encoder) numToString(number *big.Int, padToLen int) string {
	var (
		out   []rune
		digit *big.Int
	)
...
func (b *encoder) stringToNum(s string) (string, error) {
	n := big.NewInt(0)
